...
namespace Antiufo.Controls
{
    ...
    public class Windows7Renderer : ToolStripProfessionalRenderer
    {
        ...
        public static Windows7Renderer Instance
        {
            get
            {
                return _instance ?? (_instance = new Windows7Renderer());
            }
        }
...
Color.FromArgb(212, 212, 212), Color.FromArgb(195, 195, 195)
        ...
        private static GradientItemColors _itemToolItemCheckedColors = new GradientItemColors(/*****/ _rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
            
            //new GradientItemColors(/*****/ _rL, _rM, _rN, _rO, _rP, _rQ, _rR, _rS, _r9, _rA);
        private static GradientItemColors _itemToolItemCheckPressColors = new GradientItemColors(/*****/ _rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            else if (e.ToolStrip is StatusStrip)
            {
                ...
                if ((backRect.Width > 0) && (backRect.Height > 0))
                {
                    ...
                    using (var backBrush = new LinearGradientBrush(topRect, _statusBarDark, _statusBarLight, LinearGradientMode.Vertical))
                    {
                        //backBrush.Blend = _statusStripBlend;
            ...
            else
            {
                ...
                if ((toolStrip.Height > 0) && (toolStrip.Width > 0))
                {
                    ...
                    using (var topBrush = new LinearGradientBrush(topRect, clrWindows7topBegin, clrWindows7topEnd, LinearGradientMode.Vertical))
                        e.Graphics.FillRectangle(topBrush, topRect);

                    using (var bottomBrush = new LinearGradientBrush(bottomRect, clrWindows7bottomBegin, clrWindows7bottomEnd, LinearGradientMode.Vertical))
